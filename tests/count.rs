...
const PLASMA: &str = "tests/data/plasma.c";
...
const FE: &str = "tests/data/fe25519.c";
...
const EBC: &str = "tests/data/ebcdic.c";
...
const DUMB: &str = "tests/data/dumb.c";
...
const IPL: &str = "tests/data/ipl_funcs.c";
...
const LUA: &str = "tests/data/lua.lua";
...
const RUBY: &str = "tests/data/test.rb";
...
const OCAML: &str = "tests/data/ocaml.ml";
...
const REASON: &str = "tests/data/reason.re";
...
// single only
const ADA: &str = "tests/data/ada.ada";
...
const GHERKIN: &str = "tests/data/gherkin.feature";
...
const GROOVY: &str = "tests/data/test.groovy";
...
const TERRAFORM: &str = "tests/data/test.tf";
...
const ZIG: &str = "tests/data/zig.zig";
...
const NIX: &str = "tests/data/test.nix";
...
const POWERSHELL: &str = "tests/data/test.ps1";
...
const HANDLEBARS: &str = "tests/data/test.handlebars";
...
const NESTED_HASKELL: &str = "tests/data/nested-comments.hs";
...
const SOLIDITY: &str = "tests/data/test.sol";
